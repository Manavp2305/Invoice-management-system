        ...
        <div className="min-h-screen bg-white font-sans text-gray-900">
            ...
            <nav className="fixed w-full bg-white/80 backdrop-blur-md z-50 border-b border-gray-100">
                <div className="container mx-auto px-6 py-4 flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-4">
                        {user ? (
                            <Link to="/dashboard" className="bg-indigo-600 text-white text-sm font-bold px-5 py-2.5 rounded-full hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200">
                                Go to Dashboard
                            </Link>
                        ) : (
                            <>
            ...
            <section className="relative pt-32 pb-20 overflow-hidden">
                ...
                <div className="container mx-auto px-6 text-center relative z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white border border-indigo-100 text-indigo-700 rounded-full font-bold text-xs uppercase tracking-wide mb-8 shadow-sm animate-fade-in-up">
                        <Zap size={14} fill="currentColor" />
                        <span>AI-Powered Invoicing is Here</span>
                    </div>

                    <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-tight mb-6 max-w-5xl mx-auto text-gray-900">
                    ...
                    <p className="text-xl text-gray-500 max-w-2xl mx-auto mb-10 leading-relaxed">
                        Appifly helps freelancers and businesses create stunning invoices, track payments, and get paid faster with smart automation.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
                        <Link to="/register" className="flex items-center justify-center gap-2 bg-indigo-600 text-white text-lg font-bold px-8 py-4 rounded-full hover:bg-indigo-700 transition-all hover:scale-105 shadow-xl shadow-indigo-200 ring-4 ring-indigo-50">
                            Start Creating Free <ChevronRight size={20} />
                        </Link>
                        <a href="#features" className="flex items-center justify-center gap-2 bg-white text-gray-700 border border-gray-200 text-lg font-bold px-8 py-4 rounded-full hover:bg-gray-50 transition-colors hover:border-gray-300">
                            Explore Features
                        </a>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto border-t border-gray-100 pt-10">
                        <div className="text-center">
                            <div className="text-3xl font-bold text-gray-900">{formatCount(stats.invoiceCount)}</div>
                            <div className="text-sm text-gray-500 font-medium">Invoices Generated</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold text-gray-900">{formatCurrency(stats.totalProcessed)}</div>
                            <div className="text-sm text-gray-500 font-medium">Processed</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold text-gray-900">{stats.uptime}</div>
            ...
            <section id="features" className="py-24 bg-gray-50">
                <div className="container mx-auto px-6">
                    <div className="text-center max-w-3xl mx-auto mb-16">
                        ...
                        <p className="text-gray-500 text-lg">Stop wrestling with spreadsheets. Invoice manager handles the boring stuff so you can focus on work.</p>
                    </div>
